...
from cfg_utils import connect_stim_electrodes_with_fallback
...
if __name__ == "__main__":
    ...
    final_electrodes, stim_units, subs = connect_stim_electrodes_with_fallback(
        stim_electrodes, array, max_search_radius=5
    )
    if subs:
        print(f"电极替换: {subs}")
        stim_electrodes = final_electrodes  # 后续逻辑用替换后的电极
